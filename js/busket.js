...
ens_jQuery(document).ready(function() {
    ...
    if (window['EasyNetShop'] == undefined) {
        ...
        ens_jQuery('body').append('<div class="easynetshop-modalcontainer">' +
            '<div class="easynetshop-modal easynetshop-modal-addtocart"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button><span class="easynetshop-modal-title easynetshop-modal-caption">The product has been added to the cart</span></div><div class="easynetshop-modal-body easynetshop-center"><button type="button" class="easynetshop-continue">Back to the site</button><button type="button" class="easynetshop-gotocart">Place an order</button><br></div><div class="easynetshop-recomended"></div><div class="easynetshop-footer"></div></div>' +
            '<div class="easynetshop-modal easynetshop-modal-cart"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button><span class="easynetshop-modal-title easynetshop-modal-caption">Making an order</span></div><div class="easynetshop-modal-body"></div><div class="easynetshop-recomended"></div><div class="easynetshop-footer"><button type="button" class="easynetshop-continue">Back to the site</button> <button type="button" class="easynetshop-doorder">To order</button><br><br></div></div>' +
            '<div class="easynetshop-modal easynetshop-modal-ordercompleate"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button>The order has been placed</div><div class="easynetshop-center  easynetshop-ok"><button type="button" class="easynetshop-continue">Back to the site</button><button type="button" class="easynetshop-returntocart">Go back to the order</button><br><br></div></div>' +
            '<div class="easynetshop-modal easynetshop-modal-cartempty"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button><span class="easynetshop-modal-title  easynetshop-modal-caption">Your shopping cart is empty</span></div><div class="easynetshop-modal-body">Nothing has been selected yet!</div><div class="easynetshop-footer"><div class="easynetshop-center  easynetshop-ok"><button type="button" class="easynetshop-continue">Go back to the site</button></div></div></div>' +
            '<div class="easynetshop-modal easynetshop-modal-leavepopup"><div class="easynetshop-modal-header"><button type="button" class="easynetshop-close">×</button><span class="easynetshop-modal-title  easynetshop-modal-caption">Attention!</span></div><div class="easynetshop-modal-body">---</div><div class="easynetshop-center"><button type="button" class="easynetshop-continue">Back to the site</button> <button type="button" class="easynetshop-gotocart">Place an order</button><br><br></div></div></div>' +
...
function easynetshop_last_order_show() {
        	  ...
        	  if (ens_last_order != undefined)
	            ...
	            {
	               ens_jQuery('.easynetshop-modal-ordercompleate .easynetshop-modal-body').html('The order has not been placed yet');
	            }
	          ens_jQuery('.easynetshop-modal-fade-wrapper').show();
	          ens_jQuery('.easynetshop-modal-ordercompleate').show();
	          ens_jQuery('.easynetshop-modalcontainer').show();
